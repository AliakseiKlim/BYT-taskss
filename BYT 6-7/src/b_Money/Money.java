...
public class Money implements Comparable {
	...
	public String toString() {
        return getAmount()/100d + " " + getCurrency().getName();
	}
	...
	public Boolean equals(Money other) {
        Integer am = universalValue();
        Integer am2 = other.universalValue();
        return am.equals(am2);
	}
	...
	public Money add(Money other) {
        Integer total = getAmount() + getCurrency().valueInThisCurrency(other.getAmount(), other.getCurrency());
        return new Money(total, getCurrency());
	}
	...
	public int compareTo(Object other) {
        return Integer.compare(universalValue(), ((Money) other).universalValue());
	}
}